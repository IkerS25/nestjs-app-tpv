...
export class ProductoService {
    ...
    async update(id: number, dto: ProductoDto): Promise<any> {
        ...
        dto.idProveedor ? producto.idProveedor = dto.idProveedor : producto.idProveedor = producto.idProveedor;
        dto.idCategoria ? producto.idCategoria = dto.idCategoria : producto.idCategoria = producto.idCategoria;
